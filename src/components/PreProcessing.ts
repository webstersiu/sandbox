import { PerspectiveCamera, Scene, WebGLRenderer,ReinhardToneMapping,PCFSoftShadowMap, EventDispatcher } from 'https://cdn.skypack.dev/three@0.137';
...
class PreProcessing {
    ...
    constructor(scene: Scene) {
        ...
        this.camera = new PerspectiveCamera(40, innerWidth / innerHeight, 1, 200);
